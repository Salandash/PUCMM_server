...
namespace server
{
    class Program
    {
        //Método para la validación de disponibilidad del puesto.
        ...
        //Función para obtener los MimeTypes
        ...
        static int Main(string[] args)
        {
            ...
            #region Port and Path Validations
            ...
            Server.StateChanged += (sender, evt) =>
            {
                ...
                Console.WriteLine("Server State: "+ Server.State);
                Console.WriteLine();

            };

            Server.RequestReceived += (sender, evt) =>
            {
                    Console.WriteLine();
                    Console.WriteLine("Base 64 String: " + evt.Request.Form.Get("photo"));
            };
            #endregion
